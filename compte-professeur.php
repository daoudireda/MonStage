...
<link rel="stylesheet" type="text/css" href="css/compte-professeur.css">
...
<body>
	...
	<div class="container">
		<div class="suggestion">
			...
			<label for="type">Liste des suivis :</label>
               <select name="suivi" value="">
                    <option selected ="selected">choisir les etudiant dans la liste</option>
                      <option>1</option>
                        </select>
			
			<a href="detail-stage.php?id= <?php echo $_SESSION['id'] ?>"><button  name="Ajouter" class="rounded1" type="submit"> Ajouter un etudiant   </button></a>
			</div>
		</div>
		</div>
		<footer>
