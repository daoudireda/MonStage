...
if (isset($_POST['Ajouter'])) 
{
		...
		$civilite_prof = htmlspecialchars($_POST['civilite_prof']);
		...
		if (!empty($_POST['prenom_prof']) AND !empty($_POST['nom_prof'])  AND !empty($_POST['identifiant']) AND !empty($_POST['motdepasse'])) {
			# code...
				$insertmbr = $bdd ->prepare("INSERT INTO ajout_prof ( id_administration, civilite_prof, prenom_prof, nom_prof, mobile, fixe, identifiant, motdepasse) VALUES( ?, ?, ?, ?, ?, ?, ?, ?)");
					$insertmbr -> execute(array( $_SESSION['id'], $civilite_prof, $prenom_prof, $nom_prof, $mobile, $fixe, $identifiant, $motdepasse));
					header("Location: professeurs.php?id=".$_SESSION['id']);
		...
		<div class="in-etablissement">
			...
			<div class="Administrateur du compte établissement">
				...
				<label for="type">Civilite :</label>
                        <select name="civilite_prof" value="<?php echo $user['civilite']; ?>">
                        	<option selected ="selected">M.</option>
                        	<option>Mme.</option>
                        </select><br>
                        <label for="Prenom">Prenom :</label>
                        <input type="text" id="prenom" name="prenom_prof" value=""/> <br>

                        <label for="Nom">Nom :</label>
                        <input type="text" id="nom" name="nom_prof" value=""/><br>
			...
			<div class="identification">
				...
				<input type="email" id="email" name="identifiant" value=""> <br>
			...
			<button class="rounded" type="submit" name="Ajouter">Valider</button>
			</div>
			</form>
