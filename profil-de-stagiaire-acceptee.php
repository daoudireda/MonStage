...
<head>
	...
	<title></title>
		<link rel="stylesheet" type="text/css" href="css/profil-de-stagiaire-acceptee.css">
...
<body>
	...
	<section class="aside-menu">
			...
			<ul>
				...
				<li><a href="profil-de-stagiaire.php?id= <?php echo $_SESSION['id'] ?>"><span>Definir un  stagiaire</span><i class="fas fa-check"></i></a></li>
				...
				<li><a href=""><span>Suivre mes stagiaires</span><i class="fas fa-comments"></i></a></li>
...
<div class="container">
	...
	<div class="container">
		<div class="suggestion">
			...
			<h3>Aucun profil n'a été défini</h3>
			<a href="detail-profil-de-stagiaire-acceptee.php?id= <?php echo $_SESSION['id'] ?>"><button name="Ajouter" class="rounded1" type="submit">Ajouter un profile de stagiaire</button></a>
			<br>
			</div>
		</div>
