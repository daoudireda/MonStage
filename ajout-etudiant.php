...
$requser = $bdd->prepare("SELECT * FROM ajout_etudiant JOIN  etudiant WHERE ajout_etudiant.id_etudiant = etudiant.id and etudiant.id=".$_SESSION['id'] );
$requser->execute();
...
<body>
	...
	<div class="container">
		<div class="suggestion">
			...
			extract($ajout);	
			 ?>
			<a href="#" title=""><p><?php echo $ajout['email_etudiant'];  ?></p></a>
			<?php }?>
			<a href="nouvel-etudiant.php?id=<?php echo $_SESSION['id'] ?>"><button  name="Ajouter" class="rounded1" type="submit"> Ajouter un etudiant   </button></a>
			<br>
			</div>
		</div>
		</div>
