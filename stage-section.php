...
<link rel="stylesheet" type="text/css" href="css/stage-section.css">
...
<body>
	...
	<div class="container">
		<div class="suggestion">
			...
			<h3>Aucun stage n'a été créé dans cette section</h3>
			<a href="#"><button name="Ajouter" class="rounded1" type="submit">Ajouter une periode</button></a>
			<br>
			</div>
		</div>
		</div>
